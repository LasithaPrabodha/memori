...
interface NoMemoryTodayProps {
  toggleModal: () => void;
}

const NoMemoryToday: React.FC<NoMemoryTodayProps> = ({toggleModal}) => {
  return (
    <TouchableOpacity style={styles.nomemory} onPress={() => toggleModal()}>
